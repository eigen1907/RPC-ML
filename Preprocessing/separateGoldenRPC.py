...
def separateGolden2018(rpcImonFile, outputFile1, outputFile2):
    ...
    ### rpcImonData1: 2018-07-27 ~ 2018-08-19 23:00:00 (Dropping section)
    rpcImonData1 = rpcImonData[(rpcImonData.Imon_change_date > pd.to_datetime("2018-07-27")) & (rpcImonData.Imon_change_date < pd.to_datetime("2018-08-19 23:00:00"))]
    ### rpcImonData2: Start ~ 2018-07-27 | 2018-08-19 23:00:00 ~ End (Normal Section)
    rpcImonData2 = rpcImonData[(rpcImonData.Imon_change_date < pd.to_datetime("2018-07-27")) | (rpcImonData.Imon_change_date > pd.to_datetime("2018-08-19 23:00:00"))]
...
if __name__ == "__main__":
    ...
    IN_PATH_2018 = "/store/hep/users/eigen1907/CMS-RPC_store/DataStore/Imon-preprocessed_data/GoldenRPC/2018/"
    ...
    OUT_PATH_2018_DROPPING = "/store/hep/users/eigen1907/CMS-RPC_store/DataStore/Imon-preprocessed_data/GoldenRPCSeparate/2018_dropping/"
    OUT_PATH_2018_NORMAL = "/store/hep/users/eigen1907/CMS-RPC_store/DataStore/Imon-preprocessed_data/GoldenRPCSeparate/2018_normal/"
