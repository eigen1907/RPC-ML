...
if __name__ == "__main__":
    rpcImonPath = "/store/hep/users/eigen1907/CMS-RPC_store/DataStore/ImonPreproc/OriginalSep/"
    plotPath = "/store/hep/users/eigen1907/CMS-RPC_store/PlotStore/DataPreview/OriginSep/"
