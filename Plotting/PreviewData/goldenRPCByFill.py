...
if __name__ == "__main__":
    rpcDataPath = "/store/hep/users/eigen1907/CMS-RPC_store/DataStore/ImonPreproc/GoldenRPCByFill/"
    rpcPlotPath = "/store/hep/users/eigen1907/CMS-RPC_store/PlotStore/DataPreview/GoldenRPCByFill/"
